...
object Firework:
  ...
  def next(firework: Firework): Firework =
    firework match
      case Waiting(countDown, startPosition, numberOfParticles, particlesColor) =>
        Waiting(countDown, startPosition, numberOfParticles, particlesColor).next
      case Launched(countDown, position, direction, numberOfParticles, particlesColor) =>
        Launched(countDown, position, direction, numberOfParticles, particlesColor).next
      case Exploding(countDown, particles) =>
        Exploding(countDown, particles).next
      case Done =>
        Done
